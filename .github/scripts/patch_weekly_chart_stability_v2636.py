...
# v2.6.36: stabilize the PC/iPad weekly comparison canvas when switching panels/resizing.
...
test('weekly chart keeps stable canvas size after hidden-panel redraws on iPad and PC', async ({ page }) => {
  for (const viewport of [
    { width: 1024, height: 768, expectedHeight: 350 },
