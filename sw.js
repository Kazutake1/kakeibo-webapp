...
const CACHE_NAME='kakeibo-v2.6.67-stable';
const APP_SHELL=['./','./index.html','./style.css?v=2.6.67','./app-data.js?v=2.6.67','./app-sync.js?v=2.6.67','./app-charts.js?v=2.6.67','./app-ui.js?v=2.6.67','./manifest.json','./icon-192.png','./icon-512.png'];
